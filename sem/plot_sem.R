...
p4 <- ggplot() + 
  ...
  theme(legend.position="bottom",plot.title = element_text(hjust = 0.5))
p4
ggsave(filename = "sem_tau.pdf", plot = p5, device = NULL, path = "./sem/figures/",
       scale = 1, width = width, height = height, units = "in", dpi=5000)
...
p5 <-ggplot() + 
  ...
  theme(legend.position="bottom",plot.title = element_text(hjust = 0.5))
p5
ggsave(filename = "sem_rho_plot.pdf", plot = p6, device = NULL, path = "./sem/figures/",
       scale = 1, width = width, height = height, units = "in", dpi=5000)
...
p6
ggsave(filename = "sem_ess_plot.pdf", plot = p15, device = NULL, path = "./sem/figures/",
       scale = 1, width = width, height = height, units = "in", dpi=5000)
